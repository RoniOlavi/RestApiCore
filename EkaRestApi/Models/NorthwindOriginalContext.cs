...
namespace RestApiCore.Models
{
    public partial class NorthwindOriginalContext : DbContext
    {
        ...
        public virtual DbSet<ProductSales10BestForAllTime> ProductSales10BestForAllTimes { get; set; }
        public virtual DbSet<ProductSalesFor1997> ProductSalesFor1997s { get; set; }
        public virtual DbSet<ProductSalesForAllTime> ProductSalesForAllTimes { get; set; }
        ...
        {
            if (!optionsBuilder.IsConfigured) // Connection string siirretty appsettings.json tiedostoon
            {
                optionsBuilder.UseSqlServer("Server=salainen;"); // Tätä ei käytetä!
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductSales10BestForAllTime>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductSales10Best forAllTimes");
            ...
            modelBuilder.Entity<ProductSalesForAllTime>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Product Sales forAllTimes");
